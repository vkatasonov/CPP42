...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/13 11:51:25 by vkatason          #+#    #+#             */
/*   Updated: 2024/09/13 16:00:40 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
    ...
    Serializer(const Serializer &);                 // Prevent copy construction
    Serializer &operator=(const Serializer &rhs);   // Prevent assignment
    ~Serializer();
};
