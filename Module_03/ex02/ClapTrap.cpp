...
/*   Updated: 2024/08/12 18:07:02 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(std::string const &target)
{
    ...
    {
        this->_energy -= 1;
        std::cout << BLUE << " 😘 ClapTrap " << this->_name << " attack " << target << ", causing " << this->_damage << " damage points!" << RST << std::endl;
    }
...
{
	if (this->_health == 0)
		std::cout << RED << " 🪦 ClapTrap " << this->_name << " is dead! You can't damage dead body!" << RST << std::endl;
	else if (amount >= this->_health)
	{
		std::cout << RED << " 🪦 ClapTrap " << this->_name << " takes " << this->_health << " damage points and dies! RIP!" << RST << std::endl;
		this->_health = 0;
        this->_energy = 0;
	}
	else
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << RED << " 🪦 OOOOPS! You can't repaire dead body! ClapTrap " << this->_name << " is already dead!" << RST << std::endl; 
    }
}
