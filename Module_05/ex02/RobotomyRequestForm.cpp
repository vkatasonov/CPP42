...
/*   Updated: 2024/09/05 16:40:20 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RobotomyRequestForm.hpp"

RobotomyRequestForm::RobotomyRequestForm() : AForm("robotomy", "default",
    72, 45)
{
}

RobotomyRequestForm::RobotomyRequestForm(const std::string &target) : AForm("robotomy",
    target, 72, 45)
{
}
...
void RobotomyRequestForm::execute(const Bureaucrat &bureaucrat) const
{
    ...
    {
        std::cout << RED << "The robotomy failed on " << this->getTarget() << "." << RST << std::endl;
    }
}
