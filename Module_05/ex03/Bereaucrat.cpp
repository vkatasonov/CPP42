...
/*   Updated: 2024/09/04 17:23:55 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(AForm &form) const
{
    ...
    {
        form.execute(*this);
        std::cout << GREEN << this->getName() << " executed " << form.getFormName() << RST << std::endl;   
    }
    catch(const std::exception& e)
    {
        std::cerr << BG_RED << this->getName() << " cannot execute " << form.getFormName()<< ": " << e.what() << RST << std::endl;
    }
}
